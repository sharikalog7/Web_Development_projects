...
<html lang="en">
    ...
    <body style="padding-top:40px;padding-left:20px;background-color: white;">
        <!-- Header -->
    ...
    <div class="dropdown-content">
      ...
      <a href="#">Placement</a>
                        ...
                        <li><a href="registration.php"><span class="glyphicon glyphicon-user" style="color:red"></span>Sign Up</a></li>
                        <li><a href="login.php"><span class="glyphicon glyphicon-log-in" style="color:red"></span> Login</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-sm-4">
                        <a href="events.html#placements" >
                            <div class="thumbnail">
                                <img src="tpo.jpg" alt="">
                                <div class="caption">
                                    <h3><a href="#technical">PLACEMENT</a></h3>
