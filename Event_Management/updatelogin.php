...
<body>
  ...
  <div class="container" id="con">
    <form action="updatepass.php" method="POST" style="max-width:500px;margin:auto">
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="password" placeholder="enter new Password" name="pass">
  </div>

  <button type="submit" class="btn" name="submit">Update password</button> <br>
