...
<body>
  ...
  <h3>Not registered .. <a href="adminregister.php" > Register Here !!!</a></h3>
       ...
       <!--Footer-->
        ...
        <footer style="background-color:white; padding-bottom: 10px;padding-top: 400px;width:100px;">
            <div class="container"  style="background-color:whitesmoke;padding-left:20px;">
